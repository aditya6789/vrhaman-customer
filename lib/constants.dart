...
const Color primaryColor = Color.fromRGBO(255, 154, 0, 1);
const Color secondaryColor = Color.fromRGBO(199, 54, 88, 0.096);
const Color darkbackgroundColor = Color.fromRGBO(24, 28, 20, 1);
...
TextStyle mediumTextStyleWhite = TextStyle(
    fontSize: 16.sp, fontWeight: FontWeight.w500, color: Colors.white);

basicBackgroundColor(BuildContext context) {
